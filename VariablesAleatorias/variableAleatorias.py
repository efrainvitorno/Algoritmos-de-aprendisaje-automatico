...
# Calcular la suma total de ciudadanos que asistieron y que no asistieron a votar
total_electores = df['ELECTORES'].sum()
total_asistieron = df['VOTOS TOTAL'].sum()
total_no_asistieron = total_electores - total_asistieron

# Guardar resultados en una lista
resultados = []

resultados.append(f"**Total de ciudadanos que asistieron a votar:** {total_asistieron}")
resultados.append(f"**Total de ciudadanos que no asistieron a votar:** {total_no_asistieron}")

resultados.append(f"**Ejercicio 1:**\n\n> Promedio de los votos en la población: **{promedio_x:.2f}**\n\nEste ejercicio calcula el promedio de los votos totales en la población.")
